...
describe('Service Tests', () => {
    ...
    describe('AutoTip Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AutoTipService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/auto-tips';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AutoTip', () => {

                let entity: AutoTip;
                service.find(123).subscribe((_entity: AutoTip) => {
                    entity = _entity;
                });
