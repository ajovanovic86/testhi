...
import mehanicar.config.audit.AuditEventConverter;
import mehanicar.domain.PersistentAuditEvent;
...
import static mehanicar.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
